...
<html>
<head>
<title><!--[proxywebpack:site_name]--></title>
<meta name="description" content="<!--[proxywebpack:meta_description]-->">
<meta name="keywords" content="<!--[proxywebpack:meta_keywords]-->">
<style type="text/css">
/* GLOBAL ELEMENTS */
html,body {
   margin: 0; padding: 0;
...
<body>
   ...
   <div id="wrapper">
      ...
      <div id="header">
         <h1><a href="index.php"><?php	 	         // Just a bit of PHP to auto-color a multiple word name
         global $themeReplace;
      ...
      <!-- CONTENT START -->
        ...
        <!--[proxywebpack:proxy_description]-->
         
         <h2>Enter URL</h2>
         
	<!--[proxywebpack:index_above_form]-->
         ...
         <form action="includes/process.php?action=update" method="post" onSubmit="return updateLocation(this);" class="form">
            ...
            <ul id="options">
                  ...
                  <input style="display:none" type="checkbox" name="encodeURL" id="encodeURL"  checked="checked">
	...
	<!--[proxywebpack:index_below_form]-->
		...
		<div id="footer">
			&copy 2007 <a href="index.php"><!--[proxywebpack:site_name]--></a>
		</div>
